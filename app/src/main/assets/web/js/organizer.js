...
(function (root) {
  ...
  const P = root.SandeshikaParser || (typeof require !== 'undefined' ? require('./parser.js') : null);
  ...
  function extractBill(sms) {
    ...
    return {
      ...
      status: 'open',   // open | paid | dismissed
    };
  }
  ...
  if (typeof window !== 'undefined') window.SandeshikaOrganizer = API;
